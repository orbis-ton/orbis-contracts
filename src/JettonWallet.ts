...
export function loadGetNftData(slice: Slice) {
  ...
  return {
    ...
    individualContent: _individualContent,
  };
}
...
function storeTupleMerkleProof(source: MerkleProof) {
  ...
  builder.writeCell(
    source.proof.size > 0
      ? beginCell().storeDictDirect(source.proof, Dictionary.Keys.Uint(32), Dictionary.Values.BigUint(256)).endCell()
      : null
  );
...
export function loadMintNFT(slice: Slice) {
  const sc_0 = slice;
  if (sc_0.loadUint(32) !== 3845502486) {
    throw Error('Invalid prefix');
  }
  const _queryId = sc_0.loadUintBig(64);
...
export function storeUpdateCollection(src: UpdateCollection) {
  return (builder: Builder) => {
    ...
    b_0.storeUint(src.queryId, 64);
    b_0.storeAddress(src.responseDestination);
    if (src.collectionContent !== null && src.collectionContent !== undefined) {
      b_0.storeBit(true);
      b_0.store(storeTep64TokenData(src.collectionContent));
    } else {
      b_0.storeBit(false);
    }
    if (src.itemContentUrlPrefix !== null && src.itemContentUrlPrefix !== undefined) {
      b_0.storeBit(true).storeStringRefTail(src.itemContentUrlPrefix);
    } else {
      b_0.storeBit(false);
    }
    const b_1 = new Builder();
    if (src.royalty !== null && src.royalty !== undefined) {
      b_1.storeBit(true);
...
export function loadUpdateCollection(slice: Slice) {
  const sc_0 = slice;
  if (sc_0.loadUint(32) !== 1218840839) {
    throw Error('Invalid prefix');
  }
  const _queryId = sc_0.loadUintBig(64);
  const _responseDestination = sc_0.loadAddress();
  ...
  return {
    ...
    responseDestination: _responseDestination,
    collectionContent: _collectionContent,
    itemContentUrlPrefix: _itemContentUrlPrefix,
    royalty: _royalty,
  };
}
...
export function loadGiverData(slice: Slice) {
  ...
  return {
    $$type: 'GiverData' as const,
    owner: _owner,
    myJettonWalletAddress: _myJettonWalletAddress,
    myJettonAmount: _myJettonAmount,
...
async function JettonWallet_init(balance: bigint, owner: Address, master: Address) {
  const __code = Cell.fromHex(
    ''
  );
...
const JettonWallet_types: ABIType[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'denominator', type: { kind: 'simple', type: 'uint', optional: false, format: 'coins' } },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'forwardAmount', type: { kind: 'simple', type: 'uint', optional: false, format: 'coins' } },
  ...
  },
  {
    ...
    header: null,
    fields: [
      { name: 'init', type: { kind: 'simple', type: 'bool', optional: false } },
      { name: 'index', type: { kind: 'simple', type: 'uint', optional: false, format: 256 } },
      ...
      { name: 'individualContent', type: { kind: 'simple', type: 'cell', optional: false } },
    ],
  },
  {
    name: 'CollectionData',
    header: null,
    fields: [
      { name: 'nextItemIndex', type: { kind: 'simple', type: 'int', optional: false, format: 257 } },
  ...
  },
  {
    ...
    header: null,
    fields: [
      { name: 'flag', type: { kind: 'simple', type: 'uint', optional: false, format: 8 } },
      { name: 'content', type: { kind: 'simple', type: 'string', optional: false } },
    ],
  },
  {
    name: 'SetStaticTax',
    header: 352953376,
    fields: [{ name: 'staticTax', type: { kind: 'simple', type: 'uint', optional: false, format: 'coins' } }],
  },
  {
  ...
  },
  {
    ...
    fields: [
      { name: 'data', type: { kind: 'simple', type: 'cell', optional: false } },
      { name: 'root', type: { kind: 'simple', type: 'uint', optional: false, format: 256 } },
      { name: 'proof', type: { kind: 'dict', key: 'uint', keyFormat: 32, value: 'uint', valueFormat: 256 } },
      { name: 'proofLen', type: { kind: 'simple', type: 'uint', optional: false, format: 32 } },
    ],
  },
  {
    name: 'MintNFT',
  ...
  },
  {
    ...
    fields: [
      { name: 'queryId', type: { kind: 'simple', type: 'uint', optional: false, format: 64 } },
      { name: 'responseDestination', type: { kind: 'simple', type: 'address', optional: false } },
      { name: 'collectionContent', type: { kind: 'simple', type: 'Tep64TokenData', optional: true } },
      { name: 'itemContentUrlPrefix', type: { kind: 'simple', type: 'string', optional: true } },
      { name: 'royalty', type: { kind: 'simple', type: 'RoyaltyParams', optional: true } },
    ],
  },
  {
    name: 'NftItemInitForwardPayload',
    header: null,
    fields: [{ name: 'index', type: { kind: 'simple', type: 'uint', optional: false, format: 256 } }],
  },
  {
  ...
  },
  {
    name: 'MaybeAddress',
    header: null,
    fields: [{ name: 'address', type: { kind: 'simple', type: 'address', optional: true } }],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'forwardPayload', type: { kind: 'simple', type: 'slice', optional: false, format: 'remainder' } },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      { name: 'queryId', type: { kind: 'simple', type: 'uint', optional: false, format: 64 } },
      { name: 'receiver', type: { kind: 'simple', type: 'address', optional: false } },
      { name: 'tonAmount', type: { kind: 'simple', type: 'uint', optional: false, format: 'coins' } },
      { name: 'mintMessage', type: { kind: 'simple', type: 'JettonTransferInternal', optional: false } },
    ],
  },
  ...
  { name: 'Withdraw', header: 1337, fields: [] },
  {
    ...
    fields: [
      { name: 'owner', type: { kind: 'simple', type: 'address', optional: false } },
      { name: 'myJettonWalletAddress', type: { kind: 'simple', type: 'address', optional: false } },
      { name: 'myJettonAmount', type: { kind: 'simple', type: 'uint', optional: false, format: 'coins' } },
      { name: 'nftCollectionAddress', type: { kind: 'simple', type: 'address', optional: false } },
    ],
  },
  {
    name: 'OMGiver$Data',
