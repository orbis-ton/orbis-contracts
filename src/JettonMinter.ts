...
function loadTupleJettonMinterState(source: TupleReader) {
...
function loadGetterTupleJettonMinterState(source: TupleReader) {
    const _totalSupply = source.readBigNumber();
    const _mintable = source.readBoolean();
    const _adminAddress = source.readAddress();
    const _jettonContent = source.readCell();
...
function storeTupleJettonMinterState(source: JettonMinterState) {
    const builder = new TupleBuilder();
...
function dictValueParserJettonMinterState(): DictionaryValue<JettonMinterState> {
    return {
        serialize: (src, builder) => {
...
export type ChangeOwnerr = {
    $$type: 'ChangeOwnerr';
    queryId: bigint;
    newOwner: Address;
}

export function storeChangeOwnerr(src: ChangeOwnerr) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(3, 32);
        b_0.storeUint(src.queryId, 64);
...
export function loadChangeOwnerr(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3) { throw Error('Invalid prefix'); }
    const _queryId = sc_0.loadUintBig(64);
    const _newOwner = sc_0.loadAddress();
    return { $$type: 'ChangeOwnerr' as const, queryId: _queryId, newOwner: _newOwner };
}

function loadTupleChangeOwnerr(source: TupleReader) {
    const _queryId = source.readBigNumber();
    const _newOwner = source.readAddress();
    return { $$type: 'ChangeOwnerr' as const, queryId: _queryId, newOwner: _newOwner };
}

function loadGetterTupleChangeOwnerr(source: TupleReader) {
    const _queryId = source.readBigNumber();
    const _newOwner = source.readAddress();
    return { $$type: 'ChangeOwnerr' as const, queryId: _queryId, newOwner: _newOwner };
}

function storeTupleChangeOwnerr(source: ChangeOwnerr) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.queryId);
    builder.writeAddress(source.newOwner);
    return builder.build();
...
function dictValueParserChangeOwnerr(): DictionaryValue<ChangeOwnerr> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeChangeOwnerr(src)).endCell());
        },
        parse: (src) => {
            return loadChangeOwnerr(src.loadRef().beginParse());
        }
    }
}
...
export function storeGiverData(src: GiverData) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.myJettonWalletAddress);
        b_0.storeCoins(src.myJettonAmount);
        b_0.storeAddress(src.nftCollectionAddress);
    };
}

export function loadGiverData(slice: Slice) {
    const sc_0 = slice;
    const _owner = sc_0.loadAddress();
    const _myJettonWalletAddress = sc_0.loadAddress();
    const _myJettonAmount = sc_0.loadCoins();
    const _nftCollectionAddress = sc_0.loadAddress();
    return { $$type: 'GiverData' as const, owner: _owner, myJettonWalletAddress: _myJettonWalletAddress, myJettonAmount: _myJettonAmount, nftCollectionAddress: _nftCollectionAddress };
}

function loadTupleGiverData(source: TupleReader) {
    const _owner = source.readAddress();
    const _myJettonWalletAddress = source.readAddress();
    const _myJettonAmount = source.readBigNumber();
    const _nftCollectionAddress = source.readAddress();
    return { $$type: 'GiverData' as const, owner: _owner, myJettonWalletAddress: _myJettonWalletAddress, myJettonAmount: _myJettonAmount, nftCollectionAddress: _nftCollectionAddress };
}

function loadGetterTupleGiverData(source: TupleReader) {
    const _owner = source.readAddress();
    const _myJettonWalletAddress = source.readAddress();
    const _myJettonAmount = source.readBigNumber();
    const _nftCollectionAddress = source.readAddress();
...
function storeTupleGiverData(source: GiverData) {
    const builder = new TupleBuilder();
    builder.writeAddress(source.owner);
...
function dictValueParserGiverData(): DictionaryValue<GiverData> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeGiverData(src)).endCell());
        },
        parse: (src) => {
            return loadGiverData(src.loadRef().beginParse());
        }
    }
}

export type OMGiver$Data = {
    $$type: 'OMGiver$Data';
    owner: Address;
    myJettonWalletAddress: Address;
    myJettonAmount: bigint;
...
export function storeOMGiver$Data(src: OMGiver$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.myJettonWalletAddress);
...
export function loadOMGiver$Data(slice: Slice) {
    const sc_0 = slice;
    const _owner = sc_0.loadAddress();
    const _myJettonWalletAddress = sc_0.loadAddress();
    const _myJettonAmount = sc_0.loadCoins();
    const _nftCollectionAddress = sc_0.loadAddress();
    return { $$type: 'OMGiver$Data' as const, owner: _owner, myJettonWalletAddress: _myJettonWalletAddress, myJettonAmount: _myJettonAmount, nftCollectionAddress: _nftCollectionAddress };
}

function loadTupleOMGiver$Data(source: TupleReader) {
    const _owner = source.readAddress();
    const _myJettonWalletAddress = source.readAddress();
    const _myJettonAmount = source.readBigNumber();
    const _nftCollectionAddress = source.readAddress();
...
function loadGetterTupleOMGiver$Data(source: TupleReader) {
    const _owner = source.readAddress();
    const _myJettonWalletAddress = source.readAddress();
    const _myJettonAmount = source.readBigNumber();
    const _nftCollectionAddress = source.readAddress();
...
function storeTupleOMGiver$Data(source: OMGiver$Data) {
    const builder = new TupleBuilder();
    builder.writeAddress(source.owner);
    builder.writeAddress(source.myJettonWalletAddress);
    builder.writeNumber(source.myJettonAmount);
...
function dictValueParserOMGiver$Data(): DictionaryValue<OMGiver$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeOMGiver$Data(src)).endCell());
        },
        parse: (src) => {
            return loadOMGiver$Data(src.loadRef().beginParse());
        }
    }
}
...
async function JettonMinter_init(totalSupply: bigint, owner: Address, jettonContent: Cell, mintable: boolean) {
    const __code = Cell.fromHex('');
...
export const JettonMinter_errors = {
    ...
    63406: { message: `Insufficient gas for discovery` },
} as const
...
export const JettonMinter_errors_backward = {
    ...
    "Notification not from your jetton wallet!": 12495,
    ...
    "Insufficient gas for discovery": 63406,
} as const
...
const JettonMinter_types: ABIType[] = [
    ...
    {"name":"ChangeOwnerr","header":3,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"newOwner","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"JettonTransferNotification","header":1935855772,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"sender","type":{"kind":"simple","type":"address","optional":false}},{"name":"forwardPayload","type":{"kind":"simple","type":"slice","optional":false,"format":"remainder"}}]},
    {"name":"Withdraw","header":1337,"fields":[]},
    {"name":"GiverData","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"myJettonWalletAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"myJettonAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"nftCollectionAddress","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"OMGiver$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"myJettonWalletAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"myJettonAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"nftCollectionAddress","type":{"kind":"simple","type":"address","optional":false}}]},
]
...
const JettonMinter_receivers: ABIReceiver[] = [
    ...
    {"receiver":"internal","message":{"kind":"typed","type":"ChangeOwnerr"}},
...
export const gasForBurn = 6000n;
export const gasForDiscovery = 6500n;
export const gasForTransfer = 8000n;
...
export class JettonMinter implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: JettonBurnNotification | ProvideWalletAddress | JettonUpdateContent | Mint | ChangeOwnerr | CloseMinting) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'ChangeOwnerr') {
            body = beginCell().store(storeChangeOwnerr(message)).endCell();
        }
